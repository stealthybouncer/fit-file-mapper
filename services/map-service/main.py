...
class MapService:
    ...
    def __init__(self):
        ...
        self.tile_urls = {
            'satellite': f"{self.usgs_base_url}/USGSImageryOnly/MapServer/tile",
            'topo': f"{self.usgs_base_url}/USGSTopo/MapServer/tile",
            'hybrid': f"{self.usgs_base_url}/USGSImageryTopo/MapServer/tile"
        }
